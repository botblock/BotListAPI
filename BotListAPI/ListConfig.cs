...
namespace BotListAPI
{
    public class ListConfig
    {
        ...
        /// <summary> Discord Bots Review token | https://discordbotsreview.tk </summary>
        public string DiscordBotsReview = "";
        ...
        /// <summary> Discord Bots List token | http://discordbotslist.com </summary>
        public string DiscordBotsList = "";
